...
code:`tau` uses a logger named 'tau' but does not add any logging handlers. Accordingly, logs will be printed to
code:`sys.stderr` if the application using :code:`tau` does not specify any other logging configuration
